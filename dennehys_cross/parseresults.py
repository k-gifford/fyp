...
def parse_plot_waiting_vehicles():
    edgeids = ['-33708057#2', '-33708057#1', '-138139938#0', '35202667#1', '-173864128', '462149208', '-173864145#1',
...
def parse_plot_ns_waiting_vehicles():
    ...
    plot_all_tl_alg_vehicles(static_north_south_waiting_vehicles,
                             actuated_north_south_waiting_vehicles,
                             dynamic_north_south_waiting_vehicles)
...
def parse_plot_ew_waiting_vehicles():
    ...
    plot_all_tl_alg_vehicles(static_east_west_waiting_vehicles,
                             actuated_east_west_waiting_vehicles,
                             dynamic_east_west_waiting_vehicles)
